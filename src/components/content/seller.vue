    ...
    <div class="seller" ref="seller">
        <div class="seller-content">
            <div class="overview">
                ...
                <div class="desc bottom-boder-1px">
            ...
            <div class="bulletin">
                ...
                <div class="content-wrapper bottom-boder-1px">
                    <p class="content">{{seller.bulletin}}</p>
                </div>
                <ul v-if="seller.supports" class="supports">
                    <li class="support-item bottom-boder-1px" v-for="(item, index) in seller.supports">
            ...
            <split></split>
            <div class="info">
                <h1 class="title bottom-boder-1px">商家信息</h1>
                <ul>
                    <li class="info-item bottom-boder-1px" v-for="info in seller.infos">{{info}}</li>
                </ul>
            </div>
        </div>
    </div>
...
import {saveToLocal, loadFromlLocal} from '../../util/store.js';
...
export default {
    ...
    created() {
        ...
        // this.favorite = loadFromlLocal(this.seller.id, )
    },
    components: {
        star,
        split
